...
// exception class mode 2
class Invalid_Mode2_Complex_Value : public std::invalid_argument
{
	public:

	Invalid_Mode2_Complex_Value() :std::invalid_argument("Invalid value for inputting Complex # using Mode 2") {}
};
